...
<a href="javascript:void(0);" onclick="return impirmir('<?php echo $nombres_completos; ?>');" id="eva" class="btn btn-outline-dark" ><strong>Imprimir Información</strong></a> <!--id="print"-->
