   ...
   <div class="container">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?php echo base_url().'ResultadoFinal/ResultadoFinal/imprimir_prueba_rapida/' ?>',
                type: 'POST',
                dataType: 'json',
        ...
        $(document).ready(function() {
            var id_paciente = "<?php echo $this->uri->segment(4,0); ?>";
            $.ajax({
                url: '<?php echo base_url().'ResultadoFinal/ResultadoFinal/Mostrar_paquete_01/';?>',
                method: 'POST',
                dataType: 'json',
                data: {id_paciente: id_paciente},
            })
        ...
        $(document).ready(function() {
             var id_paciente = "<?php echo $this->uri->segment(4,0); ?>";
            $.ajax({
                url: '<?php echo base_url().'ResultadoFinal/ResultadoFinal/mostramos_archivos_pdf_id_paciente/';?>',
                type: 'POST',
                //dataType: 'json',
                data: {id_paciente: id_paciente},
            })
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?php echo base_url().'ResultadoFinal/ResultadoFinal/mostrar_rwegistros_online_del_oit/';?>',
                type: 'POST',
                dataType: 'json',
                data: {id_paciente: id_paciente},
            })
      ...
      $(document).ready(function() {
        /* Act on the event */ 
            id_paciente = "<?php echo $this->uri->segment(4,0); ?>";  
            $.ajax({
                    url: '<?php echo base_url().'ResultadoFinal/ResultadoFinal/Mostrar_prueba_rapida/' ?>',
                    type: 'POST',
                    dataType: 'json',
                    data: {id_paciente: id_paciente},
                  })
