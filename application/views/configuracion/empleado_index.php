<?php if (!empty($configuracion_usuarios_empleado)) {
        foreach ($configuracion_usuarios_empleado as $emp) {
            $nombrex = $emp->nombres;
            $rucx = $emp->usuario;
            $urlx = $emp->url;
            $emailx = $emp->email;
        ...
        redirect(base_url().'Intranet_view/');
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><?php echo $nombrex; ?>, estas actualizando tus datos :)</h4>
                                <form class="form-horizontal form-material"   autocomplete="on" id="actualizar_datos" method="post" action="#" >
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <a class="btn btn-outline-danger btn-rounded btn-md" href="<?php echo base_url().'Intranet_view/';?>"><i class="fas fa-reply"></i>&nbsp;Cancelar</a>
                                        </div>
                                    </div>
            ...
            $(document).ready(function() {
                $(document).on('submit', '#actualizar_datos', function(event){
                  ...
                  $.ajax({
                    url: '<?php echo base_url().'Mantenimiento/Configuracion/actualizar_usuario_x_empleado_xx/';?>',
                    method:'POST',  
