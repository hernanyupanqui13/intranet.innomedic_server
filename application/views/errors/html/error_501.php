...
<link rel="stylesheet" href="<?php echo base_url().'assets/';?>error/style.css">
...
<div class="center">
  ...
  <div class="circle circle--inner">
    ...
    <a href="<?php echo base_url();?>"><div class="button" style="color: white">GO HOME</div></a>
  </div>
  <div class="sorry">¡Uy! Lo sentimos, página no encontrada.</div>
</div><a class="inspiration" href="javascript:void(0);" >Inspiration</a>
<!-- partial -->
  <script  src="<?php echo base_url().'assets/';?>error/script.js"></script>
