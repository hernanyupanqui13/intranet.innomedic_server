...
<header>
    <table width="100%" border="1" class="head_table">
        ...
        <tr>
            <td rowspan="2" class="table-headtext">CARGO DE RECEPCIÓN DEL REGLAMENTO INTERNO DE TRABAJO</td>
...
<h1 class="main_title">CARGO DE RECEPCIÓN DE REGLAMENTO INTERNO DE TRABAJO</h1>
<p class="body_text-p">Conste por el presente documento, que, he recibido y se me ha 
    capacitado sobre el Reglamento Interno de Trabajo 
    de INNOMEDIC INTERNATIONAL E.I.R.L.
