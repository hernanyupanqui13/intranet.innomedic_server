            ...
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="index.html">
                        <h3 class="box-title m-b-20">Seleccione</h3>
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <select name="" id="Seleccionar" class="form-control">
                                	<option value="">Programacion en Linea</option>
                                	<option value="">Ingreso al Intranet</option>
                                </select>
                            </div>
                        </div>
