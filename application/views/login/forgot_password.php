...
<head>
    ...
    <title>Recuperar Contraseña | Innomedic.pe</title>
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="" method="post" action="<?php echo base_url().'Main/forgot_passwrod/'?>">
                        <h3 class="box-title m-b-20">Recuperar Contraseña</h3>
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" type="email" required="" name="email" id="email" placeholder="Ingrese su email">
                            </div>
                        </div>
                        <div class="form-group text-center p-b-10">
                            <div class="col-xs-12">
                                <button class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Recuperar Contraseña</button>
                            </div>
                        </div>
                    </form>
                </div>
