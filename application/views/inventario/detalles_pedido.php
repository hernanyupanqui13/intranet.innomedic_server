                            ...
                            <div class="row">
                                            ...
                                            <h4 class="font-bold"><?php foreach($listacombo1 as $x){ ?>
                                                   <?php
                                                       if($cliente==$x->Id){
                                                           ...
                                                           $data =  $x->nombres.' '.$x->apellido_paterno.' '.$x->apellido_materno;
                                                       }else{
                                                           echo "";
                                                       }
                                                   ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="text-right" id="ocultar_print">
                                        <a href="javascript: window.history.go(-1)" class="btn btn-danger" ><i class="fa fa-reply m-r-5"></i><span> Regresar </span></a>
