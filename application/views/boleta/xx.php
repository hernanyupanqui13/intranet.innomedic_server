                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)"
                                aria-expanded="false"><i class="ti-palette"></i><span class="hide-menu">Ui Elements
                                    <span class="badge badge-pill badge-primary text-white ml-auto">25</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="tablesaw no-wrap table-bordered table-hover table" data-tablesaw>
                                    <thead>
                                        <tr>
                                            <th scope="col" class="border"><label><input type="checkbox" data-tablesaw-checkall><span
                                                        class="sr-only">
                                                        Check
                                                        All</span></label></th>
                                            <th scope="col" class="border">Movie Title <a href="#"
                                                ...
                                                <a href="#" data-tablesaw-checkall="#checkall-target"
                                                    ...
                                                    data-tablesaw-checkall="#checkall-target" data-tablesaw-checkall-unchecked>Uncheck
                                                    All</a>
                                            </th>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="tablesaw no-wrap table-bordered table-hover table" data-tablesaw-mode="swipe"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border"><abbr
