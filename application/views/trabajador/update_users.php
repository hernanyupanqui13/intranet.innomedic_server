                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control custom-select select2" name="id_perfil" style="width: 100%">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name ="estado"  id="estado" class="form-control select2x" style="width: 100%">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row text-center">
	                                                <div class="col-md-offset-3 col-md-12">
	                                                    <a href="javascript:void(0)" onclick="return regresar();" class="btn btn-outline-danger btn-rounded"><i class="fas fa-reply-all"></i>&nbsp;Regresar</a>
	                                                    <button type="submit" class="btn btn-outline-success btn-rounded"><i class="fas fa-check-circle"></i>&nbsp;Actualizar</button>
	                                                </div>
                                                </div>
                                            </div>
                	...
                	function regresar() {
                		Swal.fire({
						  ...
						  if (result.value) {
						    ...
						    window.location ="<?php echo base_url().'Mantenimiento/Trabajador/';?>"
						  }
