...
function mayuscula()
{
    return "onkeyup='mayus(this);'";
}

function correlativo($numero){
    if(strlen($numero)==1){
        return "00000".$numero;
...
function fecha_mdy($fecha){
    $a1 = explode('-', $fecha);
    $a2 = $a1[1].'/'.$a1[2].'/'.$a1[0];
    return $a2;
}

function fecha_mdy_ext($fecha){
    $a1 = explode('-', $fecha);
    $a2 = $a1[0].'-'.$a1[1].'-'.$a1[2];
    return $a2;
}

function fecha_mdy_reversa($fecha){
    $a1 = explode('-', $fecha);
    $a2 = $a1[2].'-'.$a1[1].'-'.$a1[0];
    return $a2;
}
...
function moneda($numero){
    ...
    $a1 =   explode(".", $num);
    $a2 =   number_format($a1[0],0);
    return $a2.".".$a1[1];
}

function numero_(){
    return "onkeypress='return numero_(event)'";
}
